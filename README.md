...
- For amd64: ``ALICE_SSE3, ALICE_SSSE3, ALICE_SSE4_1, ALICE_SSE4_2, ALICE_SSE4A, ALICE_AVX, ALICE_AVX2, ALICE_AVX512F, ALICE_AVX512 (which entails all the other ALICE_AVX512X flags), ALICE_AVX10_1, ALICE_AVX10_2, ALICE_APX``
