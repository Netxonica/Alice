...
#ifndef alice_header_guard_operator_subtraction
#define alice_header_guard_operator_subtraction
...
namespace Alice::Operator
{
     ...
     */
    template<class Self, class Rhs> concept Subtraction = requires(Self self, Rhs rhs)
    {
     ...
     */
    template<class Self, class Rhs, class Return = Self> concept ReturnSubtraction = requires(Self
    self, Rhs rhs)
    {
